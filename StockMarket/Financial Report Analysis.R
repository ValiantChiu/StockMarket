...
st <- Sys.time()
StockPrice <- FinacialReportResult %>% filter(!(公司代號 %in% c('6452','6131','1724','4152','1592','2928','3144','6124','4803','2823','6185','2456','1752','8427'))) %>% GetStockPrice #%>% filter(!(公司代號 %in% c('6452', '2642', '2484','2722','4164','2454','2851')))
et <- Sys.time()
