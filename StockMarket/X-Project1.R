...
Price <- PriceAll_201001_201901 %>% filter(そ腹 == 2439) %>% .$data %>% .[[1]]
...
Price <- Price %>% CleanDate %>% filter(Date<='2019-01-07')
...
PricePeriod <- Price %>% filter(Date > '2018-06-01')
...
Result <- PriceAll_201001_201901 %>% filter(nrown == 2232) %>% filter(そ腹 != '2498' & そ腹 != '3008' & そ腹 != '911619' & そ腹 != '911622' & そ腹 != '1418' & そ腹 != '1470' &
そ腹 != '910708' & そ腹 != '910861') %>% mutate(Result = map2(そ腹, data, GetStockAction))


Result %>% select(-data) %>% unnest %>% filter(Action == 1) 
